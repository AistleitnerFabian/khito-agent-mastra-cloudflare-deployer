/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 25a5969a52e40ebd22e624d0b103020e)
// Runtime types generated with workerd@1.20260811.1 2026-08-14 
interface __BaseEnv_Env {
	INBOX_FILES: R2Bucket;
	DATABASE: D1Database;
	INBOX_PROCESSING: Queue;
	DOCLING_PROCESSOR: Fetcher;
	NUXT_PUBLIC_CLERK_PUBLISHABLE_KEY: string;
	NUXT_CLERK_SECRET_KEY: string;
	NUXT_PUBLIC_CLERK_SIGN_IN_URL: string;
	NUXT_PUBLIC_CLERK_SIGN_UP_URL: string;
	NUXT_PUBLIC_CLERK_SIGN_IN_FALLBACK_REDIRECT_URL: string;
	NUXT_PUBLIC_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL: string;
	DOCLING_CONTAINER: DurableObjectNamespace<import("./worker/index").DoclingContainer>;
	KHITO_AGENT: Fetcher /* khito-agent */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "DoclingContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "NUXT_CLERK_SECRET_KEY" | "NUXT_PUBLIC_CLERK_SIGN_IN_URL" | "NUXT_PUBLIC_CLERK_SIGN_UP_URL" | "NUXT_PUBLIC_CLERK_SIGN_IN_FALLBACK_REDIRECT_URL" | "NUXT_PUBLIC_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL">> {}
}
